    ...
    "1": [
      {
        ...
        name: '최규리',
        company: "YE;Summit",
        description: "지속 가능한 미래를 이끄는 건, 결국 청년과 그들의 새로운 시각입니다. 이 점에서 청년들이 그들의 반짝이는 아이디어를 실현하고 세상에 선보일 수 있도록 돕는 것은 청년의 창업 문제 해결을 통해 지속 가능한 미래를 만들 수 있습니다. 다만 예비 청년 창업가들에게는 자신의 창업 아이템을 전문적으로 소개할 창구가 부족합니다. 그래서 Young Entrepreneur들이 주인공인 Summit 플랫폼을 만들고자 합니다.",
        date: "2024.10.28",
        optional_url: "",
        url: '/pt/1',
