...
import { saveAdditionalInfo } from "../apis/Member/saveAdditionalInfo";
...
function SignUp() {
  ...
  const [participant_type, setParticipantType] = useState("ENTREPRENEUR");
  ...
  const handleRequiredCheckbox = () => {
    ...
    setFormData((prevData) => ({
      ...prevData,
      consentPrivacyPolicy: isRequiredChecked,
    }));
  };
        ...
        <Items>
          ...
          <SignupContainer>
            ...
            <Inputs
              ...
              checkedValue={
                InputMessage.signup.participant_position.position.entrepreneur
                  .value
              }
 ...
 {participant_type === 'ENTREPRENEUR' && (
            ...
            <Inputs
              ...
              onChange={(e) =>
                handleInputChange("consentSummitAlerts", e.target.value)
              }
            />
